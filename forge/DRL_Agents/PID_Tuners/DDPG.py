...
class Agent:
    ...
    def __init__(self, input_dims, n_actions, max_range, min_range, 
                 alpha=0.0001, beta=0.001, gamma=0.99, max_size=1000000, 
                 tau=0.001, H1=256, H2=256, batch_size=256, noise=0.5):
        self.gamma = gamma
        self.tau = tau
        ...
        self.noise = noise
        self.max_action = max_range
        self.min_action = min_range
    ...
    def save_models(self):
        self.actor.save_weights('forge/DRL_Agents/PID_Tuners/data/'+self.actor.checkpoint)
        self.critic.save_weights('forge/DRL_Agents/PID_Tuners/data/'+self.critic.checkpoint)
        self.target_actor.save_weights('forge/DRL_Agents/PID_Tuners/data/'+self.target_actor.checkpoint)
        self.target_critic.save_weights('forge/DRL_Agents/PID_Tuners/data/'+self.target_critic.checkpoint)
    ...
    def learn(self):
        ...
        with tf.GradientTape() as tape:
            ...
            target = reward + self.gamma*critic_value_*(1-dones)
